...
/*
 * ESPN - ESD
 * Added a plugin option to the Service Provider tab which allows parameters to be appended to the site-wide IdP.
 * This was needed because Homefield requires a unique 'PartnerSpId' for each site.
 */
...
Class SAML_Settings
{
  ...
  public function get_idp_parameters()
  {
  	return (string) $this->settings['idpparameters'];
  }
  ...
  /**
   * Sets the IdP Parameters
   *
   * @param string $value The new parameters to append
   * @return void
   */
  public function set_idp_parameters($value)
  {
  	if( is_string($value) )
    {
      $this->settings['idpparameters'] = $value;
      $this->_set_settings();
    }
  }
  ...
  private function _use_defaults()
  {
    $defaults = array(
      ...
      'enabled' => false,
      'idp' => 'https://ping.com/idp/startSSO.ping',
