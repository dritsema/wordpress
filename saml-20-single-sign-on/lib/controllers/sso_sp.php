<?php
  ...
  {    
      ...
      if (!empty($_POST['idpparameters_attribute']))
      {
      	$IdP = $_POST['idp'];
      	$IdP = preg_replace("/\?.+/", "", $IdP);
      	$IdP .= '?' . $_POST['idpparameters_attribute'];
      	$this->settings->set_idp($IdP);
      }
      else
      {
      ...
      $this->settings->set_idp_parameters($_POST['idpparameters_attribute']);
