...
/**
 ...
 Description: Limit access to your site to visitors who are logged in. <strong>Modified by ESD</strong> to allow the SAML 2.0 plugin to process assertions.
 Version: 5.0.1
...
/*
 * ESPN - ESD
 * Allow saml-20-single-sign-on URLs so the user can actually login
 */
...
class Restricted_Site_Access {
	...
	public function restrict_access( $wp ) {
		...
		if (strpos($_SERVER["REQUEST_URI"], "/plugins/saml-20-single-sign-on/saml/")) {
			return;
		}
